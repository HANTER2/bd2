...
def lodhirt():
    lodhirt = [
     '' '      ', 'MdAlaminChowdhur', '      ', 'MdAlaminChowdhur', '      ', 'MdAlaminChowdhur', '      ', 'MdAlaminChowdhur', '      ', 'MdAlaminChowdhur', '      ', 'MdAlaminChowdhur', '      ', 'MdAlaminChowdhur', '      ', 'MdAlaminChowdhur', 'MdAlaminChowdhur', '      ', 'MdAlaminChowdhur', '      ', 'MdAlaminChowdhur', '      ', 'MdAlaminChowdhur', '      ', 'MdAlaminChowdhur', '      ', 'MdAlaminChowdhury', '      ', 'Md AlaminChowdhury', '      ', 'MdAlaminChowdhury', '      ', 'Md Alamin Chowdhury', '      ', 'Md Alamin Chowdhury\n']
    for o in lodhirt:
...
os.system('clear')
print(logu3)      
name= raw_input("\033[1;97m\x1b[1;91m Enter Your Name: ")
os.system('clear')
print(logo)
...
loop = 'true'
while (loop == 'true'):
    username = raw_input("\033[1;97m\x1b[1;91m Enter Tool Username: ")
    if (username == CorrectUsername):
    	password = raw_input("\033[1;97m \x1b[1;91m Enter Tool Password:  ")
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:love_hacker
            os.system('xdg-open https://m.facebook.com/Mdalamin54321')
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
    ...
    print '       Bangladesh'
    print
    jaalan('  [1]BANGLADESH  7 DIGIT CLONE  ')
    print
    jaalan('  [2]Eid Mobarok  ' +name)
    print
    print '   [3]MORE TOOLS'
    print
    jalan('    \x1b[1;91m[\x1b[1;93m4\x1b[1;91m] \x1b[1;92mFOLLOW \x1b[1;91m[\x1b[1;93m5\x1b[1;91m] \x1b[1;92mCONTACT \x1b[1;91m[\x1b[1;93m00\x1b[1;91m] \x1b[1;92mEXIT')
    action()
...
def action():
    ...
    if bch == '':
        ...
        os.system('clear')
        print(logu3)
        print("GP=(l also recommended This gp )171, 172,178,170,130,170,177,179,131,181,132,173,175")
        
        
        print("Robi-191,192 , 193 , 194 , 195 , 196,151 , 152 , 153 , 154 , 155 , 156 , 157 , 183 , 184 , 185, 186 , 191, 192,  197, 198, 199")
        try:
            c = raw_input('\nCHOOSE: \033[1;93m' )
        ...
        os.system('xdg-open https://github.com/HAKERBOYMDALAMIN')
        time.sleep(1)
        menu()
    
    elif  bch == '2':
         os.system('xdg-open https://see-me.co/ElD/?n=Alamin&t=fm')
         time.sleep(1)
         menu()
